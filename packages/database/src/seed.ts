...
async function seed() {
  ...
  // Create Admin User
  const passwordHash = await bcrypt.hash('TrustFundX@2026', 12);
  ...
  const campaigns = [
    {
      ...
      description:
        'Devastating floods have struck Kerala, displacing over 500,000 people. Immediate aid is needed for food, water, shelter, and medical care for affected families. Your donation directly helps survivors rebuild their lives.',
    ...
    },
    {
      ...
      description:
        'A magnitude 7.8 earthquake has devastated southeastern Turkey, causing widespread destruction of homes, infrastructure, and loss of life. Emergency response teams need immediate funding for search and rescue operations.',
    ...
    },
    {
      ...
      description:
        'Uncontrolled wildfires are spreading rapidly across northern California, forcing thousands of families to evacuate their homes. Emergency funds are needed for temporary housing, food, clothing, and mental health support.',
